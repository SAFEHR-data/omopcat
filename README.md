...
6. Configure the "low-frequency statistics masking" feature, by defining a threshold and a replacement value (values below the threshold will be replaced, in the summary statistics), as environment variables:
...
Run the tests from an R prompt as follows:
